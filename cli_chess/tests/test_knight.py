...
class TestKnight:
    ...
    def test_knight_can_get_to_end_position(self, w_knight, board):
        """
           0   1   2   3   4
        0 [ ] [x] [ ] [x] [ ]
        1 [x] [ ] [ ] [ ] [x]
        ...
        """
        start = Position(2, 2)
        ends = [(1, 0), (3, 0), (0, 1), (4, 1), (0, 3), (4, 3), (1, 4), (3, 4)]
    ...
    def test_knight_can_get_to_end_position_through_pieces(self, w_knight, w_pawn, board):
        """
           0   1   2   3   4
        0 [ ] [x] [ ] [x] [ ]
        1 [x] [P] [P] [P] [x]
        ...
        start = Position(2, 2)
        ends = [(1, 0), (3, 0), (0, 1), (4, 1), (0, 3), (4, 3), (1, 4), (3, 4)]
        pawn_coords = [(1, 1), (2, 1), (3, 1), (1, 2), (3, 2), (1, 3), (2, 3), (3, 3)]
        for coords in pawn_coords:
            board.add_piece(w_pawn, Position(*coords))
    ...
    def test_knight_cant_get_to_end_position(self, w_knight, w_pawn, board):
        """
           0   1   2   3   4
        0 [x] [ ] [ ] [ ] [x]
        1 [ ] [x] [ ] [x] [ ]
        ...
        """
        start = Position(2, 2)
        ends = [(0, 0), (4, 0), (1, 1), (3, 1), (1, 3), (3, 3), (0, 4), (4, 4)]
